...
abstract class $SignInRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String email, String password, Map<String, dynamic>? metadata});
}
...
class _$SignInRequestImpl extends _SignInRequest {
  ...
  @override
  String toString() {
    return 'SignInRequest(email: $email, password: $password, metadata: $metadata)';
  }
...
abstract class _SignInRequest extends SignInRequest {
  const factory _SignInRequest(
      ...
      final Map<String, dynamic>? metadata}) = _$SignInRequestImpl;
...
class _$SignInResponseImpl implements _SignInResponse {
  ...
  @override
  String toString() {
    return 'SignInResponse(accessToken: $accessToken, refreshToken: $refreshToken, user: $user, expiresIn: $expiresIn, tokenType: $tokenType)';
  }
...
abstract class _ValidationSuccess implements ValidationResult {
...
abstract class _ValidationFailure implements ValidationResult {
  const factory _ValidationFailure(final Map<String, List<String>> errors) =
...
class _$ErrorImpl implements _Error {
  const _$ErrorImpl(final Map<String, List<String>> errors) : _errors = errors;
  ...
  @override
  String toString() {
    return 'AuthState.error(errors: $errors)';
  }
...
abstract class _Error implements AuthState {
  const factory _Error(final Map<String, List<String>> errors) = _$ErrorImpl;
