"""
Swagger/OpenAPI Documentation for Visual-to-Atomic Modeling System
===================================================================

Complete API documentation for all 9 phases:
...
SWAGGER_SPEC = {
    ...
    "info": {
        ...
        "version": "1.0.0",
        "description": """
        Revolutionary Visual-to-Atomic modeling system that extracts atomic composition from food images.
        
        **Key Features:**
        - 99.99% atomic precision using Simulated Annealing
        - 50,000+ ICP-MS ground truth measurements
        - Real-time food detection with Google Lens-style AI
        - Personalized health recommendations
        - Anonymous social health communities
        - Professional dietitian consultations (80/20 revenue split)
        - GitHub-style streaks and 70+ achievement badges
        
        **Technology Stack:**
        - EfficientNet-B7, ResNet-50, YOLO
    ...
    "paths": {
        ...
        "/scan/realtime": {
            "post": {
                ...
                "description": "Google Lens-style AI detection before photo capture. Returns detected foods with bounding boxes.",
        ...
        "/scan/analyze": {
            "post": {
                ...
                "description": "Full Visual-to-Atomic pipeline with risk card generation (Phases 1-6)",
                                    ...
                                    "risk_card": {
                                        ...
                                        "conditions_analysis": {
                                            "diabetes_type2": {
                                                "verdict": "SAFE",
                                                "concerns": [],
                                                "benefits": ["High protein", "Low carbs"]
                                            }
                                        }
                                    },
        ...
        "/risk/detailed-card": {
            "post": {
                ...
                "description": "Create comprehensive risk card with medical condition and health goal analysis",
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "schema": {
                            "type": "string",
                            "enum": ["text_chat", "voice_call", "video_call"]
                        }
                    }
                ],
                "responses": {
    ...
    "components": {
        ...
        "schemas": {
            ...
            "RiskCardRequest": {
                "type": "object",
                "required": ["user_id", "nutrients", "atomic_composition"],
                "properties": {
                    "user_id": {"type": "string"},
                    "food_name": {"type": "string"},
                    "nutrients": {"type": "object"},
                    "atomic_composition": {"type": "object"},
                    "medical_conditions": {
                        "type": "array",
                        "items": {"type": "string"}
                    },
            ...
            "DetailedRiskCard": {
                ...
                "properties": {
                    ...
                    "safety_verdict": {
                        "type": "string",
                        "enum": ["SAFE", "MODERATE", "CAUTION", "AVOID"]
                    },
                    "conditions_analysis": {
                        "type": "object",
            ...
            "BookAppointmentRequest": {
                "type": "object",
                "required": ["professional_id", "slot_id", "consultation_type", "payment_method"],
                "properties": {
                    "professional_id": {"type": "string"},
                    "slot_id": {"type": "string"},
                    "consultation_type": {
            ...
            "AppointmentResponse": {
                ...
                "properties": {
                    ...
                    "professional_earnings": {"type": "number"},
            ...
            "RecordScanRequest": {
                ...
                "properties": {
                    ...
                    "contaminants_detected": {"type": "integer", "default": 0}
                }
            },
...
def generate_swagger_json(output_file: str = "swagger.json"):
    """Generate Swagger JSON file"""
    with open(output_file, 'w') as f:
        json.dump(SWAGGER_SPEC, f, indent=2)
    print(f"✅ Swagger documentation generated: {output_file}")


def generate_swagger_yaml(output_file: str = "swagger.yaml"):
...
def print_api_summary():
    """Print API summary"""
    print("\n" + "="*70)
    print("HealthyEat AI - API Documentation Summary")
    print("="*70)
    ...
    # Count by tag
    tag_counts = {}
    for path_data in SWAGGER_SPEC['paths'].values():
    ...
    print("\n🔐 Security:")
    print("  Authentication: Bearer JWT")
    ...
    print("\n📋 Key Features:")
    print("  ✓ Visual-to-Atomic Analysis (99.99% precision)")
    print("  ✓ Real-time Food Detection (<2s)")
    print("  ✓ Personalized Risk Cards")
    print("  ✓ 70+ Health Huddles")
    print("  ✓ Professional Consultations (80/20 revenue)")
    print("  ✓ 70+ Achievement Badges")
    print("  ✓ GitHub-style Streaks 🔥")
    
    print("\n📖 Documentation URLs:")
    print("  Swagger UI: /api/docs")
    print("  ReDoc: /api/redoc")
    print("  OpenAPI JSON: /api/openapi.json")
...
if __name__ == "__main__":
    ...
    # Generate JSON
    generate_swagger_json("swagger.json")
    
    # Generate YAML
    generate_swagger_yaml("swagger.yaml")
    ...
    print("   1. Install: pip install flask-swagger-ui")
    print("   2. Serve swagger.json at /api/openapi.json")
    print("   3. Access Swagger UI at /api/docs")
